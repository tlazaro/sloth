...
public class Main {
    ...
    public Main() {
        ...
        examples.add(new Example("6", "ProvokingVertex", "Shows a Triangle in the middle of the screen that changes color via provoking vertex feature", "Press SpaceBar", ExampleStatus.PERFECT, "com.belfrygames.sloth.chapter06.ProvokingVertex"));
        ...
        examples.add(new Example("8", "PixBuffs", "Blur Effect with and without PBO. In modern hardware PBOs are way faster, in my old hardware it runs slower!", "Press 'P' to swap to PBO and manual memory. +/- to change moving object speed", ExampleStatus.PERFECT, "com.belfrygames.sloth.chapter08.PixBuffs"));
    }
