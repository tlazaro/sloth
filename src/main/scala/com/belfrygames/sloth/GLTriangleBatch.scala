...
class GLTriangleBatch extends GLBatchBase {
  ...
  var pIndexes: Array[Int] = _
  // Array of indexes
  var pVerts: M3DVector3fArray = _
  // Array of vertices
  var pNorms: M3DVector3fArray = _
  // Array of normals
  var pTexCoords: M3DVector2fArray = _ // Array of texture coordinates


  var nMaxIndexes: Int = 0
  // Maximum workspace
  var nNumIndexes: Int = 0
  // Number of indexes currently used
