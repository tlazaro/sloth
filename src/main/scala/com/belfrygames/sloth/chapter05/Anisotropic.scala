...
object Anisotropic {
  ...
  def ProcessMenu(value: Int) {
    ...
    while (iLoop < TEXTURE_COUNT) {
      ...
      value match {
        ...
        case 6 => {
          val fLargest = glGetFloat(GL_MAX_TEXTURE_MAX_ANISOTROPY_EXT);
  ...
  def main(args: Array[String]): Unit = {
    ...
    glutSpecialFunc((key: Int, x: Int, y: Int) => key match {
      ...
      case GLUT_KEY_F7 => println("Anisotropic Filter"); ProcessMenu(6)
      case GLUT_KEY_F8 => println("Anisotropic Off"); ProcessMenu(7)
