...
class GLFrame {
  ...
  protected var vOrigin = new M3DVector3f	// Where am I?
  protected var vForward = new M3DVector3f	// Where am I going?
  ...
  @inline def GetForwardVector(vVector : M3DVector3f) { m3dCopyVector3(vVector, vForward); }
  ...
  @inline def GetUpVector(vVector : M3DVector3f) { m3dCopyVector3(vVector, vUp); }


  /////////////////////////////////////////////////////////////
  // Get Axes
  @inline def GetZAxis(vVector : M3DVector3f) { GetForwardVector(vVector); }
  @inline def GetYAxis(vVector : M3DVector3f) { GetUpVector(vVector); }
  @inline def GetXAxis(vVector : M3DVector3f) { m3dCrossProduct3(vVector, vUp, vForward); }
