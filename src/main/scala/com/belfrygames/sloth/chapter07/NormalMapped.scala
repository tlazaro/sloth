...
object NormalMapped {
	...
	var normalMapShader = 0	// The textured diffuse light shader
	...
	var locColorMap = 0        // The location of the color map sampler
	var locNormalMap = 0       // The location of the normal map sampler
