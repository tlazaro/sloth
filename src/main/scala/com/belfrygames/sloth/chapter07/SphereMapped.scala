...
object SphereMapped {
	...
	var sphereMapShader = 0	// The dissolving light shader
	var locMVP = 0				// The location of the ModelViewProjection matrix uniform
	var locMV = 0              // The location of the Modelview matrix
	var locNormalMatrix = 0    // The location of the Normal Matrix
