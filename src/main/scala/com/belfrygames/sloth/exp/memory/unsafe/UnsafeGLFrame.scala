...
class UnsafeGLFrame {
  ...
  // Where am I?
  protected var vOrigin: M3DVector3f = M3DVector3f(0f, 0f, 0f) // At origin

  // Where am I going?
  protected var vForward:M3DVector3f = M3DVector3f(0f, 0f, -1f) // Forward is -Z (default OpenGL)

  // Which way is up?
  protected var vUp:M3DVector3f = M3DVector3f(0f, 1f, 0f) // Up is up (+Y)
  ...
  // Move along X axis
  private[this] val vTemp = M3DVector3f();
  ...
  private[this] val vTemp2 = M3DVector3f()
  private[this] val mTemp = M3DMatrix44f()
  private[this] val mTemp2 = M3DMatrix44f()
  ...
  private[this] val mTemp3 = M3DMatrix33f()
